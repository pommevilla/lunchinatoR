...
When we read in `iowa.districts`, we got a warning message that said "automatically selected the first layer in a data source containing more than one." This is because the `iowa_congressional_districts` folder contains more than one set of geometry information. You can access these with the `layer` argument of `st_read`:
